...
*/
    ...
    if (id==0)
    {
        ...
        MPI_Scatter(A.content,perSize*N,MPI_INT,recvbuff,perSize*N,MPI_INT,0,MPI_COMM_WORLD);
        ...
        /* ===== Recv From Others ===== */
        MPI_Gather(sendbuff,perSize*K,MPI_INT,C.content,perSize*K,MPI_INT,0,MPI_COMM_WORLD);
    ...
    else
    {
        ...
        int *recvbuff=new int[perSize*N];
        int *sendbuff=new int[perSize*K];
        MPI_Scatter(NULL,perSize*N,MPI_INT,recvbuff,perSize*N,MPI_INT,0,MPI_COMM_WORLD);
        ...
        /* ===== Send Back & Free ===== */
        MPI_Gather(sendbuff,perSize*K,MPI_INT,NULL,perSize*K,MPI_INT,0,MPI_COMM_WORLD);
        delete[] recvbuff;
        delete[] sendbuff;
    }
    MPI_Finalize();
